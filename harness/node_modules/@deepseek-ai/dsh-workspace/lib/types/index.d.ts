...
export declare class WorkspaceRegistry extends Service {
    ...
    /**
     * Unarchive one session durably, removing it from the registry-global
     * archive set so it reappears in every grouping surface. The session need
     * not be known — dropping a stale archive entry is always safe. An id not
     * currently archived resolves without writing.
