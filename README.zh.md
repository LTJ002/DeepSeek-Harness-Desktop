...
| 产物 | 说明 | 下载 |
| --- | --- | --- |
| DeepSeek.Harness.Setup.0.1.8.2.exe | 安装版：按用户安装（无需管理员），创建开始菜单与桌面快捷方式 | [下载](https://github.com/LTJ002/DeepSeek-Harness-Desktop/releases/download/v0.1.8.2/DeepSeek.Harness.Setup.0.1.8.2.exe) |
| DeepSeek.Harness.0.1.8.2.Portable.exe | 便携版：绿色免安装，自解压到 exe 旁运行 | [下载](https://github.com/LTJ002/DeepSeek-Harness-Desktop/releases/download/v0.1.8.2/DeepSeek.Harness.0.1.8.2.Portable.exe) |
